...
export default function DhakaSouth() {
    useTitle('Dhaka South');
    const { data, isError, isLoading } = useGetFacebookPagesQuery({ fieldName: 'districtName', fieldValue: 'Dhaka South' });
                ...
                <div className="flex justify-between items-center px-6 py-6 shadow">
                    ...
                    <div className="flex items-start">
                        ...
                        <FacebookPageLogin
                            ...
                            districtName="Dhaka South"
                            navigateTo="/dhaka-detachment/dhaka-south"
                        />
                    </div>
                </div>
