...
export default function AllPagesOfDhakaDT() {
    useTitle('All Pages of Dhaka DT');
    const { data, isError, isLoading } = useGetFacebookPagesQuery({ fieldName: 'detachmentName', fieldValue: 'Dhaka Detachment' });
    ...
    return (
        <div className="flex h-screen">
            {/* Sidebar */}
            <Sidebar activeMenu='All Pages of Dhaka DT' />

            {/* Main Content */}
            <main className="w-[77%] overflow-y-auto">
                <div className="flex justify-between items-center px-6 py-6 shadow">
                    <h2 className='text-center text-3xl font-bold'>All Pages of Dhaka DT</h2>
                    <div className="flex items-start">
                        ...
                        <FacebookPageLogin
                            ...
                            districtName=""
                            navigateTo="/dhaka-detachment/all-pages-of-dhaka-dt"
                        />
                    </div>
                </div>
            ...
            <CreatePostModal isOpen={isModalOpen} onClose={handleCloseModal}>
                <CreatePagesPost
                    fieldName="detachmentName"
                    fieldValue="Dhaka Detachment"
