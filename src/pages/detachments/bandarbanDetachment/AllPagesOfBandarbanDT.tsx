...
export default function AllPagesOfBandarbanDT() {
    useTitle('All Pages of Bandarban DT');
    ...
    return (
        <div className="flex h-screen">
            {/* Sidebar */}
            <Sidebar activeMenu='All Pages of Bandarban DT' />

            {/* Main Content */}
            <main className="w-[77%] px-5 overflow-y-auto">
                <h2 className='text-center text-3xl py-6 mb-4 font-bold border-b'>All Pages of Bandarban DT</h2>
