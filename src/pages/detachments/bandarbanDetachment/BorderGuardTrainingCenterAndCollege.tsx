...
export default function BorderGuardTrainingCenterAndCollege() {
    useTitle('Border Guard Training Center and College');
    ...
    return (
        <div className="flex h-screen">
            {/* Sidebar */}
            <Sidebar activeMenu='Border Guard Training Center and College' />

            {/* Main Content */}
            <main className="w-[77%] px-5 overflow-y-auto">
                <h2 className='text-center text-3xl py-6 mb-4 font-bold border-b'>Pages of Border Guard Training Center and College</h2>
